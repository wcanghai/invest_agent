...
from market_web.app import DEFAULT_CONFIG, DEFAULT_DATABASE, DEFAULT_HISTORY, create_app
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--history-dir", type=Path, default=DEFAULT_HISTORY, help="历史行情缓存目录")
    return parser.parse_args()


def main() -> None:
    args = parse_arguments()
    app = create_app(args.database, args.config, args.history_dir)
